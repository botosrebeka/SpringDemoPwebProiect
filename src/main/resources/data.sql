...
insert into t_people(firstname,lastname,username,email,age,password) values ('Andrea','Munteanu','asdasd','@email',20,'pasd')
insert into t_people(firstname,lastname,username,email,age,password) values ('Iulia','Popa','asdasd','@email',20,'pasd')
insert into t_people(firstname,lastname,username,email,age,password) values ('Sorina','Radu','asdasd','@email',20,'pasd')
insert into t_people(firstname,lastname,username,email,age,password) values ('Valentin','Matei','asdasd','@email',20,'pasd')
insert into t_people(firstname,lastname,username,email,age,password) values ('Robert','Dumitru','asdasd','@email',20,'pasd')
